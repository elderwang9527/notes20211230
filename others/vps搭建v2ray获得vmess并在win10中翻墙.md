参考:https://www.youtube.com/watch?v=4KCm0emEs_I

VPS 服务器系统选择 Debian9 或以上(不知 ubuntu 是否可行) （经测试，ubuntu2004 也可以。）

V2Ray 一键安装代码：

bash <(curl -s -L https://git.io/v2ray.sh)

不考虑配置,一路 enter. 最后 v2ray url 获得 vmess.

https://github.com/2dust/v2rayN/releases/tag/4.20 下载 v2rayN-Core.zip(可能会被 360 报毒,放进白名单),解压后打开. 选择从剪贴板批量导入 url.右击图标,选择系统代理,自动配置系统代理.

以下为https://git.io/v2ray.sh包含的内容
